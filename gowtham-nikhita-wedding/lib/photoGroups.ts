...
export const PHOTO_GROUPS: PhotoGroup[] = [
  ...
  },
  {
    ...
    description: "Gowtham's crew.",
    members: ['Gowtham', "Groom's friends"],
  },
  {
    index: 8,
    name: "Bride's Friends",
    description: "Nikhita's crew.",
    members: ['Nikhita', "Bride's friends"],
  },
  {
    index: 9,
    name: "Groom's Childhood Friends",
    description: 'The ones who knew Gowtham way back when.',
    members: ['Gowtham', "Groom's childhood friends"],
  },
  {
    index: 10,
    name: "Bride's Childhood Friends",
    description: 'The ones who knew Nikhita way back when.',
    members: ['Nikhita', "Bride's childhood friends"],
  },
  {
    index: 11,
    name: "Groom's College Friends",
    description: "Gowtham's college crew.",
    members: ['Gowtham', "Groom's college friends"],
  },
  {
    index: 12,
    name: "Bride's College Friends",
    description: "Nikhita's college crew.",
    members: ['Nikhita', "Bride's college friends"],
  },
  {
    index: 13,
