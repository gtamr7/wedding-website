    ...
    <div className="max-w-2xl mx-auto">
      ...
      <AnimatePresence>
        {!guestName && (
          ...
          >
            <p className="font-display text-2xl text-gold mb-1">Place Your Bets</p>
          ...
          <motion.div key="bets" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                <h3 className="font-display text-2xl text-charcoal flex items-center gap-2"><Timer size={20} strokeWidth={2.5} className="text-charcoal/50" />Over/Unders</h3>
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <h3 className="font-display text-2xl text-charcoal flex items-center gap-2"><Target size={20} strokeWidth={2.5} className="text-charcoal/50" />Prop Bets</h3>
                <div className="flex-1 h-px bg-olive-light" />
              </div>
              <div className="space-y-4">
                {props.map((bet, i) => (
